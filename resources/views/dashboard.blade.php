<x-app-layout>
    ...
    <div class="grid place-items-center min-h-screen">
        <div class="p-4 max-w-5xl grid gap-4 sm:grid-cols-2 sm:p-8 md:grid-cols-4">
            ...
            <a href="/demand/index" class="w-32 h-32 aspect-w-1 aspect-h-1 bg-blue-500 sm:w-60 sm:h-60  text-white font-black text-center text-3xl flex items-center h-full shadow-lg hover:scale-105 hover:z-10 transition transform duration-300">VISUALIZAR DEMANDAS</a>
            ...
            <a href="/sector/index" class="w-32 h-32 aspect-w-1 aspect-h-1 bg-blue-500 sm:w-60 sm:h-60  text-white font-black text-center text-3xl flex items-center h-full shadow-lg hover:scale-105 hover:z-10 transition transform duration-300">VISUALISAR SETOR</a>
