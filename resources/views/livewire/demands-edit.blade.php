            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center items-center">
                    <div class="bg-gray-700 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-5">
                        ...
                        <form action="{{route('demand.update', $demands->first()->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <span style="display: flex;">
                                <div style="flex: 1; margin-right: 10px;">
                                    ...
                                    <input type="text" class="w-full rounded" name="title" value="{{ $demands->title }}">
                                </div>

                                <div style="flex: 1;">
                                    <label for="" class="block text-white mb-2">Issue associada</label>
                                    <input type="text" class="w-full rounded" name="attached_issue" value="{{ $demands->attached_issue }}">
                                </div>
                            </span>
                            ...
                            <div style="flex: 1;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <img src="/storage/app/public/image/jdx5s3gq5QQoQMrHKHLbrZs8DMEDssZQ6pdCt488.jpg" class="img-fluid">
                                    </div>
