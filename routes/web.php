...
Route::prefix('/demand')->name('demand.')->group(function() {
    ...
    Route::post('/destroy/{demand}', [\App\Http\Controllers\DemandsController::class, 'destroy'])->name('destroy');
...
Route::prefix('/sector')->name('sector.')->group(function() {
    ...
    Route::post('/destroy/{sector}', [\App\Http\Controllers\SectorController::class, 'destroy'])->name('destroy');
});
...
Route::prefix('/user')->name('user.')->group(function() {
    ...
    Route::post('/destroy/{user}', [\App\Http\Controllers\UserController::class, 'destroy'])->name('destroy');
